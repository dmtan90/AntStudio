...
export interface ITransaction extends Document {
    ...
    type: 'license_purchase' | 'license_renewal' | 'credits' | 'credit_purchase' | 'enterprise_contract' | 'economy_purchase' | 'credit_add';
    amount: number;
    currency: string;
    status: 'pending' | 'completed' | 'failed' | 'refunded';
    gateway: 'stripe' | 'paypal' | 'manual' | 'economy';
...
const TransactionSchema = new Schema<ITransaction>(
    {
        ...
        type: { type: String, enum: ['license_purchase', 'license_renewal', 'credits', 'credit_purchase', 'enterprise_contract', 'economy_purchase', 'credit_add'], required: true },
        amount: { type: Number, required: true },
        currency: { type: String, default: 'USD' },
        status: { type: String, enum: ['pending', 'completed', 'failed', 'refunded'], default: 'pending' },
        gateway: { type: String, enum: ['stripe', 'paypal', 'manual', 'economy'], required: true },
