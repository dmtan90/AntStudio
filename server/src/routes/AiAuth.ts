...
//         const isAntigravity: boolean = req.query.isAntigravity === 'true';

//         if (platform !== AIAccountProvider.GOOGLE) {
...
//         const url = await aiAccountManager.getAuthorizationUrl(redirectUri as string, { state, isAntigravity });
