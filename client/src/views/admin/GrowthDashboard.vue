    ...
    <div class="growth-dashboard p-6 animate-in">
        <header class="page-header mb-10 flex justify-between items-start">
            ...
            <div class="flex items-center gap-4">
                <span
                    class="text-[10px] font-black px-3 py-1 bg-green-500/10 text-green-400 border border-green-500/20 rounded-full uppercase">LIVE
        ...
        <div class="grid grid-cols-12 gap-8">
            ...
            <div class="col-span-12 grid grid-cols-1 md:grid-cols-4 gap-6">
                <div class="stat-card glass-card p-6 rounded-3xl border border-white/5">
                    <p class="text-[10px] font-black opacity-30 uppercase mb-2">Total Impressions</p>
                    <h2 class="text-2xl font-black">1.2M</h2>
                    <p class="text-[10px] text-green-400 font-bold mt-1">+12.4% vs prev week</p>
                </div>
                <div class="stat-card glass-card p-6 rounded-3xl border border-white/5">
                    <p class="text-[10px] font-black opacity-30 uppercase mb-2">Conversion Rate</p>
                    <h2 class="text-2xl font-black">3.8%</h2>
                    <p class="text-[10px] text-yellow-400 font-bold mt-1">A/B Test Variant B winning</p>
                </div>
                <div class="stat-card glass-card p-6 rounded-3xl border border-white/5">
                    <p class="text-[10px] font-black opacity-30 uppercase mb-2">Discovery Index</p>
                    <h2 class="text-2xl font-black">8.4</h2>
                    <p class="text-[10px] text-blue-400 font-bold mt-1">SEO Health: CRITICAL-GREEN</p>
                </div>
                <div class="stat-card glass-card p-6 rounded-3xl border border-white/5">
                    <p class="text-[10px] font-black opacity-30 uppercase mb-2">Viral Velocity</p>
                    <h2 class="text-2xl font-black">14.2</h2>
                    <p class="text-[10px] text-purple-400 font-bold mt-1">Clipping Engine: PEAK</p>
                </div>
            </div>
                ...
                <section
                    ...
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-sm font-black uppercase tracking-widest flex items-center gap-2">
                            <chart-pie theme="outline" /> Landing Page A/B Missions
                        </h3>
                        <el-button type="primary" size="small" class="create-btn">New Test</el-button>
                    </div>
                        ...
                        <div v-for="test in activeTests" :key="test.id"
                            ...
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <div class="flex gap-2">
                                    <span
                                        class="px-3 py-1 bg-blue-500/10 text-blue-400 text-[10px] font-black rounded-lg border border-blue-500/20">VARIANT
                                        A</span>
                                    <span
                                        class="px-3 py-1 bg-purple-500/10 text-purple-400 text-[10px] font-black rounded-lg border border-purple-500/20">VARIANT
                                        B</span>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-between text-[10px] font-black uppercase opacity-40">
                                <span>A: {{ test.conversionA }}% CR</span>
                                <span>B: {{ test.conversionB }}% CR</span>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <div class="col-span-12 lg:col-span-4 space-y-8">
                <section class="glass-card p-8 rounded-3xl border border-white/5">
                    <h3 class="text-sm font-black uppercase tracking-widest mb-6">Discovery Engine (SEO)</h3>
                    <div class="space-y-6">
                        <div class="seo-entry flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <p class="text-[10px] font-bold">Schema.org Integration</p>
                                <p class="text-[8px] opacity-40 uppercase">Verified: 100% Core Projects</p>
                            </div>
                        </div>
                        <div class="seo-entry flex items-center gap-4">
                            <div
                            ...
                            <div class="flex-1">
                                <p class="text-[10px] font-bold">Social Meta Generation</p>
                                <p class="text-[8px] opacity-40 uppercase">Dynamic OG/Twitter Tags Active</p>
                            </div>
                        </div>
