    ...
    <el-dialog v-model="showShortcutsPanel" title="" :width="800" class="shortcuts-dialog" @keydown="handleKeyRecord">
        ...
        <div class="flex items-center justify-between mb-6 pb-4 border-b border-white/10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-lg font-black text-white uppercase tracking-wider">Keyboard Shortcuts</h2>
                    <p class="text-[10px] text-white/40 font-bold uppercase">Customize your workflow</p>
                </div>
            </div>
        ...
        <div class="flex items-center gap-3 mb-6">
            <div class="flex-1 relative">
                ...
                <el-input v-model="searchQuery" placeholder="Search shortcuts..." class="pl-10" size="large" />
            </div>
        ...
        <div class="mt-6 p-3 rounded-lg bg-brand-primary/10 border border-brand-primary/20">
            <p class="text-[10px] text-brand-primary/80 font-bold uppercase">
                💡 Tip: Click "Edit" next to any shortcut and press your desired key combination
            </p>
        </div>
    </el-dialog>
</template>
