...
const enhanceAudio = async () => {
    ...
    toast.info('Enhancing audio with AI... please wait', { id: 'enhance-audio' });
    ...
    try {
        ...
        // For now, we'll use a simplified blob creation for the demo
        ...
        toast.error('Failed to enhance audio: ' + (error.message || 'Unknown error'), { id: 'enhance-audio' });
    } finally {
    ...
    <div v-if="activeAudio"
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="flex flex-col">
                <span class="text-xs font-bold text-white uppercase tracking-wider">Audio Effects</span>
        ...
        <div class="flex flex-col gap-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2 text-white/60">
                    <Equalizer size="14" />
                    <span class="text-[10px] font-bold uppercase tracking-widest">Equalizer</span>
                </div>
            </div>
        ...
        <div class="flex flex-col gap-4 p-4 rounded-xl bg-white/5 border border-white/5">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2 text-white/60">
                    ...
                    <span class="text-[10px] font-bold uppercase tracking-widest">Dynamics</span>
                </div>
            ...
            <div v-if="effects.compressor.enabled" class="flex flex-col gap-3">
                <div class="flex flex-col gap-1">
                    <div class="flex justify-between">
                        <span class="text-[9px] text-white/40 font-bold uppercase">Threshold</span>
                ...
                <div class="flex flex-col gap-1">
                    <div class="flex justify-between">
                        <span class="text-[9px] text-white/40 font-bold uppercase">Ratio</span>
        ...
        <div class="flex flex-col gap-4 p-4 rounded-xl bg-white/5 border border-white/10 border-dashed">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2 text-white/60">
                    <Waves size="14" />
                    <span class="text-[10px] font-bold uppercase tracking-widest">Automation</span>
                </div>
            ...
            <div v-else
                ...
                <span class="text-[9px] text-white/20 font-bold uppercase tracking-widest">No Keyframes</span>
            </div>
        </div>
        ...
        <div class="flex flex-col gap-4 p-4 rounded-xl bg-orange-500/5 border border-orange-500/10">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2 text-orange-400">
                    <Waves size="14" />
                    <span class="text-[10px] font-bold uppercase tracking-widest">Voice Enhancement</span>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="flex items-center justify-between bg-white/5 p-3 rounded-xl border border-white/5">
                    <div class="flex flex-col">
                        <span class="text-[10px] font-black text-white uppercase">Studio Voice</span>
                        <span class="text-[8px] text-white/40 font-bold uppercase">Clarity & Auto-Level</span>
                    </div>
                ...
                <button @click="enhanceAudio" :disabled="isEnhancing"
                    ...
                    {{ isEnhancing ? 'Processing...' : 'Clean with AI Denoise' }}
                </button>

                <!-- Noise Gate Threshold -->
                <div v-if="effects.enhancement.denoise || effects.enhancement.studio" class="flex flex-col gap-1 mt-2">
                    <div class="flex justify-between">
                        <span class="text-[9px] text-white/40 font-bold uppercase">Gate Threshold</span>
        ...
        <div class="flex flex-col gap-6 p-4 rounded-xl bg-white/5 border border-white/10">
            ...
            <div class="flex flex-col gap-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 text-white/60">
                        <Waves size="14" />
                        <span class="text-[10px] font-bold uppercase tracking-widest">Reverb</span>
                    </div>
                ...
                <div v-if="effects.reverb.enabled" class="flex flex-col gap-2">
                    <div class="flex justify-between">
                        <span class="text-[9px] text-white/40 font-bold uppercase">Mix</span>
            ...
            <div class="flex flex-col gap-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2 text-white/60">
                        <Waves size="14" />
                        <span class="text-[10px] font-bold uppercase tracking-widest">Echo / Delay</span>
                    </div>
                ...
                <div v-if="effects.echo.enabled" class="flex flex-col gap-4">
                    <div class="flex flex-col gap-1">
                        <div class="flex justify-between">
                            <span class="text-[9px] text-white/40 font-bold uppercase">Delay Time</span>
                    ...
                    <div class="flex flex-col gap-1">
                        <div class="flex justify-between">
                            <span class="text-[9px] text-white/40 font-bold uppercase">Feedback</span>
