        ...
        <div v-if="currentTab === 'credits'" class="content-section">
          ...
          <div class="credits-history">
            ...
            <div class="history-list">
              <el-empty v-if="loadingHistory" class="history-loading" :v-loading="loadingHistory" description="No transactions found" />
              <template v-else>
                <div 
          ...
          <div class="integrations-grid">
            ...
            <div class="integration-card glass-dark">
              ...
              <div class="integration-actions">
                ...
                <GButton 
                  v-else
                  @click="disconnectSocial('youtube')"
                  :loading="disconnectingYoutube"
                >
                  Disconnect
                </GButton>
              </div>
...
const handleUpgrade = async (planId: string) => {
  try {
    ...
    const response = await api.post('/subscription/create-checkout', { planId, billingCycle: billingCycle.value })
...
const disconnectSocial = async (provider: 'youtube' | 'facebook') => {
  ...
  try {
    await api.post(`/social/disconnect`, { provider })
...
.notification-settings {
  ...
  .setting-item {
    ...
    .setting-info {
      h4 { margin: 0 0 4px 0; font-size: 14px; color: #fff; }
      p { margin: 0; font-size: 12px; color: $text-muted; }
    }
  }
}
