<template>
    <div class="flex flex-col gap-6">
        <div class="panel-section space-y-4">
            <span class="text-[10px] font-bold text-orange-400 uppercase block">Live Configuration</span>
            ...
            <div class="control-item">
                ...
                <input v-model="streamConfig.serverUrl"
                    class="w-full bg-white/5 border border-white/10 rounded-lg p-2 text-[10px] text-white focus:border-orange-500/50 transition-all outline-none" />
            </div>
        ...
        <div v-if="streamStats"
            class="panel-section bg-gradient-to-br from-orange-500/10 to-transparent p-4 rounded-2xl border border-orange-500/10">
            <span class="text-[10px] font-bold text-orange-400 uppercase mb-4 block">Stream Health</span>
