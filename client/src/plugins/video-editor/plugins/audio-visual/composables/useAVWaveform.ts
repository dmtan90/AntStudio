import { watchEffect, type Ref, toValue } from 'vue'
...
export function drawBuffer(data: Uint8Array, canvas: Ref<CanvasRenderingContext2D | null>, p: Waveform) {
  ...
  ctx.decodeAudioData(data.buffer as ArrayBuffer).then(buff => {
