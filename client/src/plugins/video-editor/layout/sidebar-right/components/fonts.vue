...
<template>
  <div class="h-full w-full flex flex-col cinematic-panel bg-[#0a0a0a]/95 backdrop-blur-xl">
    ...
    <div
      ...
      <h2 class="font-bold text-xs tracking-[0.2em] uppercase text-white/90 relative z-10">{{ t('videoEditor.fonts.title') }}</h2>
      <button
    ...
    <section class="flex-1 flex flex-col relative overflow-hidden px-5 pt-6 pb-20">
      ...
      <div class="relative mb-6">
        <el-input :placeholder="t('videoEditor.fonts.searchPlaceholder')" class="cinematic-input">
          <template #prefix>
