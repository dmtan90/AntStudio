...
const transitionOptions = [
    { id: 'none', label: t('videoEditor.transition.none'), icon: Movie },
...
const directions = [
    { id: 'left', label: t('videoEditor.transition.left') },
    { id: 'right', label: t('videoEditor.transition.right') },
    { id: 'up', label: t('videoEditor.transition.up') },
    { id: 'down', label: t('videoEditor.transition.down') },
];
...
<template>
    <div class="h-full w-full flex flex-col cinematic-panel bg-[#0a0a0a]/95 backdrop-blur-xl">
        ...
        <div
            ...
            <h2 class="font-bold text-xs tracking-[0.2em] uppercase text-white/90 relative z-10">{{ t('videoEditor.transition.title') }}</h2>
            <button
            ...
            <div class="p-5 flex flex-col gap-8 pb-20">
                ...
                <div class="flex flex-col gap-6 p-5 rounded-2xl bg-white/2 border border-white/5 shadow-inner">
                    <div class="flex flex-col gap-3">
                        <div class="flex justify-between items-center mb-1">
                            <Label
                                ...
                                <Time :size="12" /> {{ t('videoEditor.transition.duration') }}
                            </Label>
                    ...
                    <div v-if="currentTransition?.hasDirection"
                        ...
                        <Label class="text-[10px] font-bold text-white/20 uppercase tracking-widest">{{ t('videoEditor.transition.direction') }}</Label>
                ...
                <div class="flex flex-col gap-4">
                    <h4 class="text-[10px] font-bold text-white/30 uppercase tracking-[0.2em]">{{ t('videoEditor.transition.presets') }}</h4>
