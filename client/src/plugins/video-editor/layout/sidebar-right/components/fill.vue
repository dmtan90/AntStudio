...
const modeOptions = computed(() => [
  {
    value: 'solid',
    label: t('videoEditor.fill.solid')
  },
  {
    value: 'gradient',
    label: t('videoEditor.fill.gradient')
  }
]);
...
<template>
  <div class="h-full w-full flex flex-col cinematic-panel bg-[#0a0a0a]/95 backdrop-blur-xl">
    ...
    <div
      ...
      <h2 class="font-bold text-xs tracking-[0.2em] uppercase text-white/90 relative z-10">{{ t('videoEditor.fill.title') }}</h2>
